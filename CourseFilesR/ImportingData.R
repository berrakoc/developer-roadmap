...
# CSV
rio_csv <- import("/Users/berrakoc/Desktop/CourseFiles/ImportingData_Datasets/mbb.csv")
head(rio_csv)

 # TXT
rio_txt <- import("/Users/berrakoc/Desktop/CourseFiles/ImportingData_Datasets/mbb.txt")
head(rio_txt)

# Excel XLSX
rio_xlsx <- import("/Users/berrakoc/Desktop/CourseFiles/ImportingData_Datasets/mbb.xlsx")
head(rio_xlsx)
